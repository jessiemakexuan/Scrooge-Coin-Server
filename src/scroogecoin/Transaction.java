...
import static hw3.ScroogeCoinServer.*;
...
public class Transaction {
   ...
   public static class Output {
      //Value in ScroogeCoin of the output
   ...
   //Scrooge's signature on CreateCoin transactions
   //Unused for PayCoin transactions
